...
<div class="container flex-shrink-0 mx-auto px-5 md:px-10 xl:px-20 overflow-x-hidden">
    <h1 class="text-2xl mb-8 text-center font-semibold uppercase mt-16">Posts</h1>
