<footer class="bg-[#213d5d] text-white py-4">
    <div class="container mx-auto px-3">
        <div class="mx-5 my-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-6">
            <div class="mx-auto mb-4 sm:mb-0 sm:col-span-1">
