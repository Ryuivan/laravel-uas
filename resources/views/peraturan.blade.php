...
<div class="bg-[#9a031e]">
    <div class="container mx-auto px-5 md:px-10 xl:px-20">
        <div class="py-20">
            ...
            <p class="mt-5 text-white text-lg lg:text-lg">Peraturan sehari-hari di Sekolah Menengah Kejuruan Perguruan
                Buddhi.
            </p>
        </div>
    </div>
        ...
        <div class="container mx-auto py-24 px-5 md:px-10 xl:px-20">
            <div class="umum">
                ...
                <ol class="ms-6 list-decimal text-justify text-base">
                    ...
                    <li class="my-1">Mengikuti upacara bendera pada hari Senin serta hari besar lainnya (sesuai
                        ketentuan).</li>
                    <li class="my-1">Mengenakan seragam Sekolah sesuai ketentuan, lengkap dengan atributnya. Tidak
                        dibenarkan
                        mengenakan seragam olahraga pada jam pelajaran lain.</li>
                    <li class="my-1">Menjaga ketertiban, ketenangan, dan kebersihan kelas masing-masing serta lingkungan
                        sekolah.
                    </li>
                    ...
                    <li class="my-1">Membayar uang SPP melalui Bank BCA paling lambat tanggal 10 pada setiap bulannya.
                    </li>
                    <li class="my-1">Mengikuti kebaktian di Vihara Sekolah dan hari lainnya boleh dilakukan di Vihara
                        tempat
                        tinggal siswa (sesuai
                        ketentuan).</li>
                </ol>
            </div>
            <div class="khusus mt-12">
                <h3 class="text-xl font-bold text-left">KHUSUS</h3>
                <p class="mt-4 text-lg">Setiap siswa wajib:</p>
                <p class="mt-4 text-base font-semibold">Kehadiran</p>
                <ol class="ms-6 list-decimal text-justify text-base">
                    <li class="my-1">Hadir di Sekolah selambat-lambatnya 15 menit sebelum jam pelajaran pertama dimulai.
                    </li>
                    <li class="my-1">Melapor kepada guru piket bila terlambat hadir.</li>
                    <li class="my-1">Memberi surat keterangan yang sah sesegera mungkin bila tidak bisa hadir di
                        sekolah, dan
                        memberikan surat
                        keterangan dokter bila sakit lebih dari 3 (tiga) hari.</li>
                    <li class="my-1">Mengajukan permohonan izin kepada wali kelas bila karena sesuatu hal siswa tidak
                        dapat
                        mengikuti pelajaran. Surat
                        permohonan harus ditanda tangani oleh orang tua/wali.</li>
                    <li class="my-1">Meminta izin kepada guru kelas/wali kelas/guru piket bila akan keluar kelas/sekolah
                        saat jam
                        pelajaran
                        berlangsung.</li>
                    <li class="my-1">Berada di sekolah sejak jam pelajaran pertama sampai dengan jam pelajaran terakhir.
                    </li>
                </ol>
                ...
                <ol class="ms-6 list-decimal text-justify text-base">
                    <li class="my-1">Segera masuk kelas bila mendengar tanda bel masuk. Tidak bergerombol di muka kelas.
                        (Bila terlambat, mengambil
                        surat izin masuk di TU).</li>
                    <li class="my-1">Melaksanakan piket kebersihan kelas sesuai dengan Jadwal. </li>
                    <li class="my-1">Duduk dengan tenang.</li>
                    <li class="my-1">Bila guru belum hadir, ketua/wakil kelas melapor pada guru piket dikantor.</li>
                    <li class="my-1">Mengikuti pelajaran dengan tertib dan tidak belajar/mengerjakan pekerjaan lain.
                    </li>
                ...
                <ol class="ms-6 list-decimal text-justify text-base">
                    <li class="my-1">Rambut tidak boleh disemir/diwarnai. Khusus laki-laki rambut dipotong pendek bagian
                        depan 2 cm diatas alis, bagian
                        atas rambut 3 cm dan bagjan belakang tidak menutupi kera baju.</li>
                ...
                <ol class="ms-6 list-decimal text-justify text-base">
                    ...
                    <li class="my-1">Mencoret-coret bangku, pintu, kursi ataupun perlengkapan lain yang ada di
                        lingkungan sekolah.
                    </li>
                    <li class="my-1">Menerima tamu tanpa persetujuan Guru/Wali Kelas, Guru Piket, Kepala Sekolah.</li>
                    <li class="my-1">Membawa, menyimpan, mengedarkan minuman yang ber-alkohol atau yang memabukkan serta
                        obat-obat
                        terlarang lainnya
                        (ganja, heroin dll).</li>
                    <li class="my-1">Membawa senjata api, senjata tajam atau benda apapun yang tidak ada hubungannya
                        dengan
                        pelajaran
                        di sekolah.</li>
                    <li class="my-1">Membawa, menyimpan dan mengedarkan buku, film atau media lainnya yang bertentangan
                        dengan
                        susila
                        dan nilai-nilai
                        budaya serta moral bangsa Indonesia.</li>
                    <li class="my-1">Berkelahi atau tawuran baik secara perorangan maupun secara masal/kelompok di
                        sekolah atau di
                        luar
                        sekolah.</li>
                    <li class="my-1">Melakukan tindakan-tindakan yang merugikan secara masal/kelompok di Sekolah atau di
                        luar
                        sekolah
                        atau milik
                        melakukan pengrusakan terhadap benda-benda perorangan demikian juga terhadap milik Sekolah.</li>
                    <li class="my-1">Memakai perhiasan dan aksesoris apapun (kalung, gelang, anting-anting dll) secara
                        berlebihan.
                    </li>
                    ...
                    <li class="my-1"> Melakukan kegiatan olah raga diluar jam pelajaran olah raga yang telah ditentukan
                        dan tanpa
                        sepengetahuan guru
                        olahraga.</li>
                </ol>
